...
class StandRelayFamilyResourceTest {
    ...
    void freshEdition() {
        ...
        edition()
                ...
                .body(String.join(
                        ...
                        "INSERT INTO creneau (edition_id, date_creneau, heure_debut, heure_fin, famille) VALUES ('"
                                + EDITION + "', '2026-08-14', '09:00', '13:00', 0);",
                        "INSERT INTO creneau (edition_id, date_creneau, heure_debut, heure_fin, famille) VALUES ('"
                                + EDITION + "', '2026-08-14', '09:15', '13:15', 1);",
    ...
    void aCreatedStandJoinsTheLeastPopulatedFamilyAndAnAddedOneMovesNobody() {
        ...
        assertThat(edition()
                        ...
                        .extract()
                        .jsonPath()
                        .getInt("find { it.id == 'STAND-E' }.famille"))
                .isZero();
    }
    ...
    void aStandStoredWithoutAFamilyGetsOneRecordedAtTheFirstBuild() throws InterruptedException {
        edition()
                ...
                .body(String.join(
                        ...
                        "INSERT INTO stand (edition_id, id, nom, effectif_min, effectif_max, reserve_majeurs) VALUES ('"
                                + EDITION + "', 'STAND-SQL', 'SQL', 1, 1, false);",
                        "INSERT INTO stand_typologie (edition_id, stand_id, typologie) VALUES ('" + EDITION
                                + "', 'STAND-SQL', 'JEU');",
                        "INSERT INTO animateur (edition_id, id, prenom, nom, date_naissance) VALUES ('" + EDITION
                                + "', 'A1', 'Ana', 'Un', '2000-01-01');"))
                .when()
                .post("/api/database/import")
                .then()
                .statusCode(200);
        assertThat((Object) edition()
                        .when()
                        .get("/api/stands")
                        .then()
                        .statusCode(200)
        ...
        String jobId = edition()
                .when()
                .post("/api/solve/async/reference-data?seconds=1&reamorcage=AUCUN")
                .then()
                .statusCode(202)
                .extract()
                .path("id");
        for (int i = 0; i < 120; i++) {
            io.restassured.path.json.JsonPath job = edition()
                    .when()
                    .get("/api/jobs/" + jobId)
                    .then()
                    .statusCode(200)
    ...
    void aWriteThatOmitsTheFamilyLeavesItAlone() {
        ...
        Map<String, Object> stand = edition()
                .when()
                .get("/api/stands")
                .then()
                .statusCode(200)
                .extract()
                .jsonPath()
                .getList("findAll { it.id == 'STAND-KEEP' }", Map.class)
                .get(0);
