...
import dev.sylvain.planning.service.ContrainteAdHocContradictions.TypeContradiction;
...
class ContrainteAdHocContradictionsTest {
    ...
    void anAffiniteOnAnAlreadyIncompatiblePairIsRefused() {
        ...
        assertThat(detect(affinite, incompatibilite))
                .singleElement()
    ...
    void aForcedSeatOnAnUnavailableSlotIsRefused() {
        ContrainteAdHoc indisponibilite = scoped("C1", TypeContrainteAdHoc.INDISPONIBILITE_FORCEE,
                MATIN, "STAND-A", "A1");
        ContrainteAdHoc forcee = scoped("C2", TypeContrainteAdHoc.AFFECTATION_FORCEE, MATIN, "STAND-A", "A1");

        assertThat(detect(forcee, indisponibilite))
                .singleElement()
                .satisfies(contradiction -> {
                    assertThat(contradiction.type())
                            .isEqualTo(TypeContradiction.AFFECTATION_FORCEE_SUR_INDISPONIBILITE);
                    assertThat(contradiction.contrainteIds()).containsExactly("C1", "C2");
    ...
    void theOrderTheTwoAreEnteredInDoesNotMatter() {
        ...
        ContrainteAdHoc indisponibilite = scoped("C2", TypeContrainteAdHoc.INDISPONIBILITE_FORCEE,
                MATIN, null, "A1");
    ...
    void twoForcedSeatsOnOverlappingCreneauxAreRefused() {
        ...
        assertThat(detect(seconde, premiere))
                .singleElement()
                .satisfies(contradiction -> {
                    assertThat(contradiction.type())
                            .isEqualTo(TypeContradiction.AFFECTATIONS_FORCEES_SIMULTANEES);
                    assertThat(contradiction.contrainteIds()).containsExactly("C1", "C2");
                    assertThat(contradiction.message()).contains("C1").contains("C2").contains("A1");
                });
    }
    ...
    void aCreneauCrossingMidnightIsComparedOnTheDayItEndsOn() {
        ...
        ContrainteAdHoc lendemain = scoped("C2", TypeContrainteAdHoc.AFFECTATION_FORCEE,
                lendemainMatin, null, "A1");

        assertThat(ContrainteAdHocContradictions.detect(lendemain, List.of(soiree), creneaux)).hasSize(1);
        assertThat(ContrainteAdHocContradictions.detect(
                scoped("C3", TypeContrainteAdHoc.AFFECTATION_FORCEE, MATIN, null, "A1"),
                List.of(soiree), creneaux)).isEmpty();
    }
    ...
    void aForcedSeatNamingTwoAnimateursCanBeSpreadOverTheTwoCreneaux() {
        ...
        ContrainteAdHoc seconde = scoped("C2", TypeContrainteAdHoc.AFFECTATION_FORCEE,
                CHEVAUCHANT, null, "A1", "A2");
    ...
    void forcingAnIncompatiblePairOntoOneCreneauIsRefused() {
        ...
        assertThat(detect(incompatibilite, premiere, seconde))
                .singleElement()
                .satisfies(contradiction -> {
                    assertThat(contradiction.type())
                            .isEqualTo(TypeContradiction.AFFECTATIONS_FORCEES_INCOMPATIBLES);
    ...
    void everyContradictionOfASetIsReportedOnceEach() {
        ...
        assertThat(ContrainteAdHocContradictions.detectAll(contraintes, CRENEAUX))
                ...
                .containsExactly(TypeContradiction.PAIRE_INCOMPATIBLE_ET_AFFINE,
    ...
    void aConsistentSetHoldsNoContradiction() {
        ...
        assertThat(ContrainteAdHocContradictions.detectAll(contraintes, CRENEAUX)).isEmpty();
    }
    ...
    void nullsAndUnidentifiedConstraintsAreIgnored() {
        ...
        assertThat(ContrainteAdHocContradictions.detect(null, contraintes, CRENEAUX)).isEmpty();
    }
    ...
    private static ContrainteAdHoc scopedPair(String id, Creneau creneau, String standId,
            String premier, String second) {
        return scoped(id, TypeContrainteAdHoc.INCOMPATIBILITE, creneau, standId, premier, second);
    }

    private static ContrainteAdHoc scoped(String id, TypeContrainteAdHoc type, Creneau creneau, String standId,
            String... animateurs) {
