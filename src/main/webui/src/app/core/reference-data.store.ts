...
/** A referential row's id: a string for most, a number for the generated ones. */
 ...
 * it sent.
 */
function writtenId(reponse: unknown): RecordId | null {
...
export class ReferenceDataStore {
  ...
  async save<T extends { id?: RecordId | null }>(
    ...
    return { id: writtenId(reponse), avertissements: avertissementsDe(reponse) };
  }
