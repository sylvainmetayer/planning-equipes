      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              text: $localize`:@@aide.views.def.day:Une journée, stand par stand et créneau par créneau. Pour vérifier une journée précise ou préparer une réparation manuelle. On y corrige aussi à la main, en glissant un nom vers un autre stand de la journée : sur un siège libre la personne y est déplacée et son siège se vide, sur une personne les deux échangent leurs sièges. Le serveur simule le geste sur le plan enregistré et le refuse, en nommant la règle, s'il cassait une règle dure ; un siège verrouillé ne se déplace pas. Le clic sur un nom reste le chemin au clavier : « Pourquoi lui ? » et son assistant de réparation. Le déplacement se prend par la poignée ⠿ à gauche du nom : le nom lui-même reste sélectionnable, et sur écran tactile le doigt continue de faire défiler la journée. Au clavier, « Pourquoi lui ? » et l'assistant de réparation donnent un siège à quelqu'un sans glisser ; échanger deux personnes ou viser un siège libre précis n'a pas d'équivalent au clavier aujourd'hui.`
            },
            {
