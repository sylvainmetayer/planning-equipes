      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            $localize`:@@aide.start.step6:Si les journées sont décrites par une simple amplitude d'ouverture, générer le découpage en vacations.`,
