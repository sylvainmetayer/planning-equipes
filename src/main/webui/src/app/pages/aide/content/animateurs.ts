        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              text: $localize`:@@aide.rappels.def.echecEnvoi:Le dernier courriel envoyé à cette personne n'est pas parti : elle n'est pas silencieuse, personne n'a pu la joindre. La date et la cause s'affichent au survol, et le filtre « Accusés » les isole. Quand le serveur d'envoi a refusé l'adresse, plus aucun courriel n'y part — publication, planning renvoyé, code d'accès, invitation, relances, rappel de la veille, échanges — tant que l'adresse n'a pas changé : modifier autre chose sur la fiche ne suffit pas. Corrigez l'adresse, ou appelez. Un échec temporaire, lui, ne bloque rien : « Renvoyer les envois en échec », en tête de page, renvoie à chacune de ces personnes le courriel qui a échoué — le planning publié, la relance ou l'invitation ; un code d'accès se redemande depuis l'espace. « Parti » veut dire accepté par le serveur d'envoi, jamais lu : une boîte pleine signalée plus tard n'arrive pas jusqu'ici.`,
            },
            {
