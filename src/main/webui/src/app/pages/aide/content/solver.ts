        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              text: $localize`:@@aide.config.def.decoupage:Pour un scénario « continu », le découpage transforme l'amplitude d'ouverture d'une journée en vacations réelles : durée cible, minimale et maximale d'une vacation, chevauchement de relais, et stratégie de couverture pendant la pause (fermer le stand, faire une relève, ou tourner à effectif réduit). Le découpage ne se lance que sur une grille déclarée en amplitudes, et la déclare en vacations finales une fois généré. Ces réglages s'éditent sur la page Créneaux, juste au-dessus de la prévisualisation et de la génération, tant que la grille est déclarée en amplitudes — en vacations finales, la carte est rangée avec le découpage, et le relais repas se déclare sur la vacation elle-même, dans le formulaire du créneau ou la journée type. Le découpage remplace les créneaux de l'édition en place : pour re-découper avec d'autres paramètres, ré-importez le scénario source. Ces paramètres déterminent le nombre de postes à pourvoir : les modifier change la taille du problème bien plus que n'importe quel réglage du solveur.`,
            },
          ],
        },
        {
