      ...
      blocks: [
        {
          ...
          items: [
            ...
            $localize`:@@aide.exchange.item.yamlValidator:Validateur YAML (page Débogage, onglet Validateur YAML) : vérifie un fichier scénario sans rien importer. La même page charge aussi un des scénarios livrés avec l'application, sous son onglet Données.`,
            ...
            $localize`:@@aide.exchange.item.debug:Débogage : l'état brut renvoyé par le serveur, sous l'onglet Résolution, utile pour rapporter un problème précisément. Il n'est pas dans le menu : Ctrl+K puis « débogage », ou son adresse /debug.`,
            ...
            $localize`:@@aide.exchange.item.sauvegarde:Sauvegarde de nuit (page Paramètres, onglet Globaux) : la base entière est copiée sur le disque du serveur chaque nuit, et l'écran dit où, lesquelles existent et si la dernière s'est bien passée. Elle ne se télécharge pas — elle porte les noms, les dates de naissance et les adresses de tout le monde — et la restauration est une opération de l'exploitant.`,
          ],
        },
      ],
      links: [
        {
          route: '/parametres',
          queryParams: { onglet: 'globaux' },
          label: $localize`:@@aide.lien.parametresGlobaux:Paramètres — onglet Globaux`,
        },
        {
          route: '/imports',
        ...
        {
          route: '/debug',
          queryParams: { onglet: 'yaml' },
          label: $localize`:@@aide.lien.debugYaml:Débogage — onglet Validateur YAML`,
        },
