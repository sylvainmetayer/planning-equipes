 ...
 *
 * The table compares everybody at a glance; « et moi ? » — one person's
 * indicators one under the other, and the radar — is the « Charge et équité »
 * section of the fiche animateur, which every name here leads to, reading the
 * same report narrowed to that person. `/equite?vue=fiche`, the reading this
 * screen used to carry, is sent there by the route.
 *
