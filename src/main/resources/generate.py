...
stands, animateurs et postes. Chaque poste référence un standId et un
creneauId existants et laisse animateurId vide (le solveur l'affectera).
...
def main():
    ...
    print(f"  {len(data['creneaux'])} créneaux, {len(data['stands'])} stands, "
