 ...
 */
public record PerimetreReplanification(Set<String> animateurIds, Set<LocalDate> jours, Set<String> standIds) {

    public PerimetreReplanification {
    ...
    public static PerimetreReplanification automatique() {
        return new PerimetreReplanification(Set.of(), Set.of(), Set.of());
    }
     ...
     */
    public boolean liberer(PosteAffectation poste, String tenantId) {
        if (estVide()) {
            return false;
        }
