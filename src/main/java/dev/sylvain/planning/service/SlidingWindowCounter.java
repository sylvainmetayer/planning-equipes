 ...
 * {@code DeclarationRateLimiter} on the declarations and
 * {@code ColleagueLookupLimiter} on a colleague's seats, in the espace,
 * {@code McpRateLimiter} on the MCP transport and
