 ...
 */
final class ValidationStand {

    private ValidationStand() {
    }

    static void verifier(Stand stand) {
        verifierEffectifs(stand);
        verifierIndisponibilites(stand);
        verifierOuvertures(stand);
        verifierModesExclusifsParJour(stand);
        verifierHoraires(stand);
    }

    private static void verifierEffectifs(Stand stand) {
     ...
     */
    private static void verifierIndisponibilites(Stand stand) {
     ...
     */
    private static void verifierOuvertures(Stand stand) {
     ...
     * rejected here — exactly as {@link #verifierModesExclusifsParJour} does for
    ...
    private static void verifierHoraire(HoraireStand horaire) {
     ...
     */
    private static void verifierModesExclusifsParJour(Stand stand) {
