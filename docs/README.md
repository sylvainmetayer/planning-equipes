...
| [`groupes.md`](groupes.md) | Cloisonnement de tout le référentiel et des résultats de solveur par groupe (« Année 2025 » / « Année 2026 ») : modèle, en-tête `X-Groupe-Id`, duplication de groupe, plan de migration |
