...
| Jours d'affilée | Pas plus de six jours travaillés consécutifs, **et le nombre se règle** sur la page Paramètres : par défaut le solveur pénalise les jours en trop sans bloquer — aucun texte n'impose un décompte glissant — et une organisation qui veut le plafond bloquant l'allume pour son édition depuis la page Contraintes. Le seuil vaut mieux que le dosage : sur une grille qui réclame presque tout le monde tous les jours, un jour de plus ou de moins décide si un planning sans écart existe |
...
| Repère du jour | Pendant l'événement, l'espace s'ouvre sur l'instant : en tête le poste en cours ou le prochain avec son lieu et la pause qui reste à prendre, la journée du jour marquée, les journées écoulées repliées derrière un bouton — jamais supprimées. Un poste de nuit reste « en cours » après minuit, et sa journée reste dépliée tant qu'on le tient. Avant le premier jour et après le dernier, la page reprend sa forme habituelle |
