...
| Pause en relais, et heures réellement travaillées | Quand l'organisation déclare que la pause légale se prend sur le poste, par relais entre collègues, le solveur **exige** qu'un collègue puisse tenir le stand pendant chaque pause due : sans personne pour relayer, la pause ne serait pas prise, et le plan est refusé comme il le serait pour un dépassement d'heures. En contrepartie, les plafonds quotidien **et hebdomadaires** déduisent cette pause : ce sont des heures de repos, pas de travail. Les écrans d'heures et d'équité continuent, eux, de compter les heures planifiées |
...
| Ouvertures des stands | Grille stand × jour de ce que le planning retiendra réellement, et les trois erreurs de saisie d'horaires habituelles — à vérifier avant de lancer un calcul ; la même grille se retourne en saisie, un effectif par stand et par créneau comme dans un tableur — collage d'un bloc, recopie d'un jour, reprise de la ligne du dessus, application d'une case à toute sa colonne ; une troisième vue pose une journée sur l'axe du temps, un stand par ligne, et hachure une ouverture déclarée hors de toute vacation |
| Renforts au-dessus de l'effectif demandé | Un stand dont la capacité dépasse ce qu'il demande ouvre des places optionnelles : le solveur y pose quelqu'un quand il en reste, et les laisser vides ne manque à personne — ni dans le décompte des sièges vides, ni dans la fragilité, ni dans le besoin en animateurs. La grille des ouvertures et le calendrier du jour les montrent à part, le PDF global les écrit « 2/3 +1 » |
