...
| Liens du symptôme vers l'écran | Un siège libre, une pause sans relais, un stand de la carte ouvrent le panneau du siège, sans quitter la Journée ; un goulot de typologie ou une compétence rare mènent aux animateurs qui la détiennent ; un avertissement à l'enregistrement rouvre la fiche ; une cause d'infaisabilité ouvre le créneau ou le stand en cause |
...
| Journée — Calendrier | Une seule page « Journée » pour quatre rendus du même jour, sous le même sélecteur de date et les mêmes filtres (stand, animateur), portés par l'adresse. Le premier rendu : la journée stand par stand et créneau par créneau, où chaque nom et chaque siège libre ouvre le panneau du siège pour corriger à la main — et, si l'instance l'active, le glisser-déposer d'un nom vers un autre stand : déplacement sur un siège libre, échange sur une personne, refusé si une règle dure serait cassée |
