...
| Jours d'affilée | Pas plus de six jours travaillés consécutifs : par défaut le solveur les pénalise sans bloquer — aucun texte n'impose un décompte glissant — et une organisation qui veut le plafond bloquant l'allume pour son édition depuis la page Contraintes |
